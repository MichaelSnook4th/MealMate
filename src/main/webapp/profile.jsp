...
<body>
    ...
    <form action="ProfileManagerServlet" method="post">
        ...
        <input type="checkbox" name="categories" value="3" ${userCategories.contains('Chinese') ? 'checked' : ''}> Chinese<br>
        <input type="checkbox" name="categories" value="4" ${userCategories.contains('Italian') ? 'checked' : ''}> Italian<br>
        <input type="checkbox" name="categories" value="5" ${userCategories.contains('American') ? 'checked' : ''}> American<br>
